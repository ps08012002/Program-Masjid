...
<div class="max-w-2xl mx-auto bg-white rounded-3xl shadow-sm border border-gray-100 p-6 sm:p-8">
    ...
    <div class="mb-8 border-b border-gray-50 pb-4">
        ...
        <p class="text-sm text-gray-500 mt-1">
            Masukkan informasi nama dan alamat wilayah baru untuk memperluas cakupan program masjid.
        </p>
    </div>

    <!-- Form -->
    <form action="{{ route('daerah.store') }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div>
            ...
            <input type="text"
                   ...
                   name="nama"
                   value="{{ old('nama') }}"
                   placeholder="Contoh: Wilayah Pusat, Daerah Selatan"
        ...
        <div>
            ...
            <textarea id="alamat"
                      name="alamat"
                      rows="4"
                      placeholder="Tuliskan alamat lengkap sekretariat atau deskripsi wilayah baru..."
